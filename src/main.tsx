  ...
  <html lang="ru" prefix="og: https://ogp.me/ns#">
    ...
    <body>
      <main>
        ...
        <p>
          <strong>Наш сайт находится в разработке!</strong> Верстальщик сайтов у нас в команде есть{' '}
          (он, собсна, и сделал эту страничку <Emote name="SanCheese" />
          ), но он - не веб-дизайнер, поэтому мы ищем <s>источник вдохновения</s> дизайн и/или макет
          для нового сайта. Тем временем, ты можешь посетить страничку нашего проекта перевода{' '}
          <a href="https://store.steampowered.com/app/368340/CrossCode/">CrossCode</a> на GitHub:
        </p>
        <p>
        ...
        <p>
          ...
          говоря, скучно там не бывает, особенно команде переводчиков <Emote name="dogroflan" />) и{' '}
          <a href={VK_URL}>группа в VK</a>!
        </p>
        <p>
          {[
            'shar',
